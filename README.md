...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-6ivofzu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-6ivofzu.containers.anotherwebservice.com/
...
```
git clone git@github.com:netzih/container-6ivofzu.git
cd container-6ivofzu
```
...
```
docker attach container-6ivofzu
```
